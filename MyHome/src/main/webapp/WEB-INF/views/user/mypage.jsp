			...
			<div class="col-md-3">
				<div class="my_icon">
					...
					<div class="Attention">
						...
						<button type="button" onclick="location.href='<c:url value="/user/userModify" />'" id="#" class="btn btn-sm btn-info btn-block" >개인정보 수정 </button>
						<button id="'#" class="btn btn-sm btn-info btn-block"
							type="submit">
							<a class="#" href="#">회원 탈퇴 </a>
						</button>
					</div>
				</div>
				...
				<div class="board">
					...
					<div class="category">
						<ul>
							<li class="category-item is-active" data-filter4="" data-sort=""
								style="margin-right: 20px;"><a href="#" class="is-active">뽐내기</a>
							</li>
							<li style="margin-right: 20px;">||</li>
							<li class="category-item" data-filter4="" data-sort="rgstdtime">
								<a href="#">질문과답변</a>
							</li>
							<li style="margin: 0 20px 0 20px">||</li>
							<li class="category-item" data-filter4="" data-sort="rgstdtime">
								<a href="#">스크랩</a>
							</li>
							<li class="category-item" data-filter4="" data-sort="rgstdtime"
					...
					<div class="col-md-3 cards">
						<div class="card" style="width: 13rem;">
							<a href="#"><img src="../img/interior10.png"
							...
							<div class="card-body">
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<a class="dete">2021-09-17</a> <a class="eye"><svg
